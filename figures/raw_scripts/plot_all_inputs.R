...
sourceterms<-readRDS('../../srs_data/processed/sourceterms.rdata')
...
print(plots1)
# With bw theme, larger axes labels
...
print(plots2)
## Create PDF file
pdf(file = "../exploratory/inputs.pdf", width = 6, height = 7, title = "Input to the basins as reported by Cummins et al. [1991]", 
...
# pdf(file = "C:/Users/Arthur/Dropbox/dissertation/th_outline/images/inputs.pdf", width = 6, height = 7, 
#     title = "Input to the basins as reported by Cummins et al. [1991]", version = "1.6", pointsize = 12)
# print(plots3)
# dev.off()

# pdf(file = "~/Dropbox/dissertation/th_outline/images/inputs.pdf", width = 6, height = 7, 
#     title = "Input to the basins as reported by Cummins et al. [1991]", version = "1.6", pointsize = 12)
# print(plots3)
# dev.off()
