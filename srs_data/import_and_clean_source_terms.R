...
sourceterms<-read.csv('./srs_data/raw/FareasourcetermforR.csv')
surfacewater<-read.csv('./srs_data/raw/surfacewatermonitoring.csv')
...
saveRDS(sourceterms,file='./srs_data/processed/sourceterms.rdata')
saveRDS(sourceterms2,file='./srs_data/processed/Srsourceterm.rdata')